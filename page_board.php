...
wp_localize_script( 'kanpress-board', 'KanpressData', array(
	...
	'userCapabilities'		=> array(
		'kanpress_task_assign'	=> kanpress_current_user_can( 'task_assign' ),
		'kanpress_task_create'	=> kanpress_current_user_can( 'task_create' ),
		'kanpress_task_remove'	=> kanpress_current_user_can( 'task_remove' ),
	),
	'l10n'					=> array(
		...
		'Confirm Removal' => __( 'Confirm Removal', 'kanpress' ),
		'You don\'t have permission to move tasks' => __( 'You don\'t have permission to move tasks', 'kanpress' ),
		'You don\'t have permission to assign tasks' => __( 'You don\'t have permission to assign tasks', 'kanpress' ),
	)
) );
